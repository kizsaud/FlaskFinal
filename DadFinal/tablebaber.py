...
class tablebabmaker:
    def tablemaker(nameofjob,versiongit):
        ...
        #ERRORED REASON
        if bb2.htr() != None:
            TestErrorAnalysis_reason,x=bb2.htr()
...
<a href="/my-link/">Delete DB items </a>
...
<script src="https://ajax.googleapis.com/ajax/libs/jquery/3.5.1/jquery.min.js"></script>''' )
        #fiel.write('''<form method = 'POST'>''')  
        #fiel.write('''<button>send logs</button>''')
        #fiel.write('''</form>''')
...
'''    )    
            ...
            resultofcoll=collection2.insert_one(dict2)
